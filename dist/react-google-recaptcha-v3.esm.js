import { createContext, createElement, Component, useContext } from 'react';
...
var GoogleReCaptchaProvider = /** @class */ (function (_super) {
    ...
    function GoogleReCaptchaProvider() {
        ...
        _this.handleOnLoad = function () {
            if ((!window || !window.grecaptcha) && window.grcScriptPlaced) {
        ...
        _this.injectGoogleReCaptchaScript = function () {
            ...
            var _a = _this.props, reCaptchaKey = _a.reCaptchaKey, language = _a.language;
    ...
    GoogleReCaptchaProvider.prototype.render = function () {
        ...
        return (createElement(GoogleReCaptchaContext.Provider, { value: this.googleReCaptchaContextValue }, children));
    };
...
var withGoogleReCaptcha = function (Component) {
    var WithGoogleReCaptchaComponent = function (props) { return (createElement(GoogleReCaptchaConsumer, null, function (googleReCaptchaValues) { return (createElement(Component, __assign({}, props, { googleReCaptchaProps: googleReCaptchaValues }))); })); };
...
export { WrappedGoogleRecaptcha as GoogleReCaptcha, GoogleReCaptchaConsumer, GoogleReCaptchaContext, GoogleReCaptchaProvider, useGoogleReCaptcha, withGoogleReCaptcha };
